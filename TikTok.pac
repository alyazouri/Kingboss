// ╔══════════════════════════════════════════════════════════════════════╗
// ║  🔥 ULTIMATE JORDAN PAC v60.0 — FINAL COMPLETE EDITION             ║
// ║  PUBG Mobile + TikTok Live + Zero Ping + 120FPS + Cool iPad        ║
// ║  Jordan 2025 — NO HEAT — NO LAG — NO DROP                         ║
// ╠══════════════════════════════════════════════════════════════════════╣
// ║  ✅ Zero-Ping DNS Cluster (12 DNS)                                  ║
// ║  ✅ TikTok Live — مشاهدين + لايكات + بث كامل                      ║
// ║  ✅ PUBG Jordan Smart Routing                                       ║
// ║  ✅ 120+ FPS Optimizer                                              ║
// ║  ✅ iPad Thermal Protection — منع السخونة                          ║
...
// ║  ✅ Emergency Tunnel                                                ║
// ║  ✅ Session Persistence                                             ║
// ║  ✅ Tracker Blocker — يقلل الحرارة                                 ║
// ║  ✅ Background Request Killer                                       ║
// ╚══════════════════════════════════════════════════════════════════════╝
...
var CFG = {
    ...
    // ═══ THERMAL PROTECTION (منع السخونة) ═══
    THERMAL_PROTECTION:       true,
    THERMAL_BLOCK_ADS:        true,
    THERMAL_BLOCK_TRACKERS:   true,
    THERMAL_BLOCK_ANALYTICS:  true,
    THERMAL_BLOCK_CRYPTO:     true,
    THERMAL_BLOCK_BACKGROUND: true,
    THERMAL_BLOCK_TELEMETRY:  true,
    THERMAL_BLOCK_METRICS:    true,

    // ═══ TIKTOK LIVE ═══
    TIKTOK_DIRECT:            true,
    TIKTOK_LIVE_PRIORITY:     true,
    TIKTOK_LIKES_FIX:         true,
    TIKTOK_VIEWERS_FIX:       true,
    ...
    ULTRA: [
        {
            ...
            tags:["sync","auth","lobby","game","live"], peak:2
        },
        {
            ...
            tags:["sync","game","ranked","live"], peak:3
        },
        {
        ...
        },
        {
            ...
            tags:["sync","auth","fps","live"], peak:1
        }
    ],
...
var GEO = {
    ...
    forceKeywords: [
        ...
        "mena-hub","me-server","gcc-hub","local","near","closest"
    ],
...
// ═══════════════════════════════════════════════════════════════════════
//  🌡️  THERMAL PROTECTION DATABASE — قاعدة بيانات السخونة
// ═══════════════════════════════════════════════════════════════════════

var THERMAL_DB = {

    // ══ دومينات الإعلانات — تسخن المعالج ══
    ads: [
        "doubleclick.net",        "googlesyndication.com",
        "googleadservices.com",   "googletagmanager.com",
        "googletagservices.com",  "google-analytics.com",
        "adnxs.com",              "adsystem.com",
        "advertising.com",        "ads.twitter.com",
        "ads.facebook.com",       "an.facebook.com",
        "moatads.com",            "scorecardresearch.com",
        "adform.net",             "adroll.com",
        "criteo.com",             "criteo.net",
        "pubmatic.com",           "rubiconproject.com",
        "openx.net",              "appnexus.com",
        "smartadserver.com",      "taboola.com",
        "outbrain.com",           "revcontent.com",
        "media.net",              "bidswitch.net",
        "sharethrough.com",       "triplelift.com",
        "33across.com",           "adsafeprotected.com",
        "rlcdn.com",              "mxpnl.com",
        "admixer.net",            "adfox.ru",
        "yandex-team.ru",         "yandexadexchange.net"
    ],

    // ══ دومينات التتبع — تسخن المعالج ══
    trackers: [
        "facebook.com",           "connect.facebook.net",
        "fbcdn.net",              "pixel.facebook.com",
        "hotjar.com",             "fullstory.com",
        "logrocket.com",          "mouseflow.com",
        "sessioncam.com",         "crazyegg.com",
        "clicktale.com",          "inspectlet.com",
        "intercom.io",            "intercom.com",
        "mixpanel.com",           "segment.com",
        "amplitude.com",          "heap.io",
        "appsflyer.com",          "adjust.com",
        "branch.io",              "kochava.com",
        "singular.net",           "tune.com",
        "mparticle.com",          "localytics.com",
        "clevertap.com",          "leanplum.com",
        "urbanairship.com",       "braze.com",
        "onesignal.com"
    ],

    // ══ دومينات Analytics — تسخن المعالج ══
    analytics: [
        ...
        "fabric.io",              "flurry.com",
        "comscore.com",           "quantserve.com",
        "chartbeat.com",          "newrelic.com",
        "datadog-browser-agent",  "sentry.io",
        "bugsnag.com",            "raygun.io",
        "rollbar.com",            "loggly.com",
        "splunkcloud.com",        "datadoghq.com",
        "instabug.com",           "bugsee.com"
    ],

    // ══ دومينات التعدين والكريبتو — تسخن المعالج جداً ══
    crypto: [
        "coinhive.com",           "coin-hive.com",
        "minero.cc",              "cryptoloot.com",
        "webminepool.com",        "webmine.pro",
        "monerominer.rocks",      "jsecoin.com",
        "load.jsecoin.com",       "papoto.com",
        "cryptonight",            "webminer",
        "monero-miner",           "bitcoin-miner",
        "crypto-miner",           "minergate.com",
        "nicehash.com"
    ],

    // ══ دومينات الخلفية — تشغل CPU وتسخن ══
    background: [
    ...
    // ══ Telemetry — تسخن وتعبر البيانات ══
    telemetry: [
        "telemetry.apple.com",
        "telemetry.pubgmobile.com",
        "telemetry.tencent.com",
        "metrics.tencent.com",
        "logserver.tencent.com",
        "crash.tencent.com",
        "errorlog.tencent.com",
        "alog.tiktok.com",
        "log.tiktok.com",
        "mon.tiktok.com",
        "metrics.tiktok.com",
    ...
    // ══ ملاحظة مهمة: TikTok Live لا يُبلك أبداً ══
    tiktokSafe: [
        "webcast",
        "webcast2",
        "webcast3",
...
var GAME_DB = {
    ...
    // ═══ PUBG DOMAINS ═══
    pubgDomains: [
        "igamecj.com",            "gcloud.qq.com",
        "tencent-cloud.net",      "lbsgame.com",
        "levelinfinite.com",      "proximabeta.com",
        "lightspeed.qq.com",      "gamenet.qq.com",
        "tmgp.qq.com",            "pubgmobile.com",
        "pubgm.com",              "bsgame.qq.com",
        "dl.pgamer.qq.com",       "resource.pgamer.qq.com",
        "anticheat.pubgm.com",    "match.pubgm.com",
        "lobby.pubgm.com",        "game-svr.tencent.com",
        "gs.tencent.com",         "garena.pubg.com",
        "levelinfinite.huya.com", "pubgops.com",
        "pubgsupport.com"
    ],
    ...
    // ═══ TIKTOK DOMAINS — كاملة ══
    tiktokDomains: [
        // Core
        "tiktok.com",             "tiktokv.com",
        "tiktokcdn.com",          "tiktokcdn-us.com",
        "tiktok-global.com",      "tiktok.org",
        // ByteDance
        "bytecdn.com",            "bytego.com",
        "bytedance.com",          "ibytedtos.com",
        "tosv.byted.org",         "byteimg.com",
        "bytegoocdn.com",
        // CDN & Streaming
        "ttlivecdn.com",          "ttw9.com",
        "ttwstatic.com",          "ttlimg.com",
        "tiktokd.com",
        // Live Streaming — مهم جداً للبث
        "livepush.tiktok.com",    "pull-hls.tiktok.com",
        "pull-flv.tiktok.com",    "pull-rtmp.tiktok.com",
        "webcast.tiktok.com",     "webcast2.tiktok.com",
        "webcast3.tiktok.com",    "webcast-ws.tiktok.com",
        "lf-webcast.tiktok.com",  "lf-webcast-sg.tiktok.com",
        // API
        "api.tiktok.com",         "api2.musical.ly",
        "i.tiktok.com",           "m.tiktok.com",
        // Misc
        "musical.ly",             "pstatp.com",
        "snssdk.com",             "iesdouyin.com",
        "ixigua.com",             "zijieapi.com",
        "byteoversea.com",        "bdstatic.com"
    ],

    // ═══ CDN DOMAINS ═══
    cdnDomains: [
        "akamai.net",             "akamaiedge.net",
        "akamaitechnologies.com", "cloudflare.com",
        "cloudflare.net",         "fastly.net",
        "fastlylb.net",           "gstatic.com",
        "cloudfront.net",         "awscloudfront.net",
        "llnwd.net",              "edgesuite.net",
        "edgekey.net",            "limelight.com"
    ],
...
// ═══════════════════════════════════════════════════════════════════════
//  🌡️  THERMAL ENGINE — محرك الحماية من السخونة
// ═══════════════════════════════════════════════════════════════════════

var THERMAL = {

    // فحص شامل هل الدومين يسخن الجهاز
    isHeatSource: function(host) {
        if (!CFG.THERMAL_PROTECTION) return false;
        var h = host.toLowerCase();

        // ✅ أولاً: حماية تيك توك لايف — لا يُبلك أبداً
        for (var s = 0; s < THERMAL_DB.tiktokSafe.length; s++) {
            if (h.indexOf(THERMAL_DB.tiktokSafe[s]) !== -1) return false;
        }

        // ✅ حماية PUBG — لا يُبلك أبداً
        if (isPUBG(h)) return false;

        // 🔥 فحص الإعلانات
        if (CFG.THERMAL_BLOCK_ADS) {
            for (var a = 0; a < THERMAL_DB.ads.length; a++) {
                if (h.indexOf(THERMAL_DB.ads[a]) !== -1) return true;
            }
        }

        // 🔥 فحص التتبع
        if (CFG.THERMAL_BLOCK_TRACKERS) {
            for (var t = 0; t < THERMAL_DB.trackers.length; t++) {
                if (h.indexOf(THERMAL_DB.trackers[t]) !== -1) return true;
            }
        }

        // 🔥 فحص Analytics
        if (CFG.THERMAL_BLOCK_ANALYTICS) {
            for (var n = 0; n < THERMAL_DB.analytics.length; n++) {
                if (h.indexOf(THERMAL_DB.analytics[n]) !== -1) return true;
            }
        }

        // 🔥 فحص Crypto Mining
        if (CFG.THERMAL_BLOCK_CRYPTO) {
            for (var c = 0; c < THERMAL_DB.crypto.length; c++) {
                if (h.indexOf(THERMAL_DB.crypto[c]) !== -1) return true;
            }
        }

        // 🔥 فحص Background
        if (CFG.THERMAL_BLOCK_BACKGROUND) {
            for (var b = 0; b < THERMAL_DB.background.length; b++) {
                if (h.indexOf(THERMAL_DB.background[b]) !== -1) return true;
            }
        }

        // 🔥 فحص Telemetry
        if (CFG.THERMAL_BLOCK_TELEMETRY) {
            for (var e = 0; e < THERMAL_DB.telemetry.length; e++) {
                if (h.indexOf(THERMAL_DB.telemetry[e]) !== -1) return true;
            }
        }
...
var FPS_ENGINE = {
    ...
    // دومينات تحسن الـ FPS عبر CDN سريع
    fpsBoostDomains: [
        "cloudflare","akamai","fastly",
        "cloudfront","gstatic","cdn"
    ],

    // فحص إذا CDN مفيد للـ FPS
    isPositive: function(host) {
        if (!CFG.FPS_CDN_PRIORITY) return false;
        var h = host.toLowerCase();

        // تيك توك لا يحتاج FPS route
        if (h.indexOf("tiktok")    !== -1) return false;
        if (h.indexOf("bytedance") !== -1) return false;
    ...
    // تقدير الـ FPS الحالي بناءً على الشبكة
...
var DNS_ENGINE = {
    ...
    init: function() {
        ...
        var hot = [
            "igamecj.com",            "gcloud.qq.com",
            "lightspeed.qq.com",      "match.pubgm.com",
            "lobby.pubgm.com",        "anticheat.pubgm.com",
            "bsgame.qq.com",          "resource.pgamer.qq.com",
            "tiktok.com",             "tiktokcdn.com",
            "webcast.tiktok.com",     "livepush.tiktok.com",
...
var LATENCY_AI = {
    ...
    predict: function() {
        ...
        return Math.max(0, Math.round(current + this.trend * 3 * this.confidence));
    },
...
var JITTER = {
    ...
    _calcBuffer: function() {
        ...
        var sum = 0, sumSq = 0, len = this.samples.length;
        for (var i = 0; i < len; i++) {
            sum   += this.samples[i];
...
function markProxyHealth(id, success, ping) {
    if (!PROXY_HEALTH[id]) {
        PROXY_HEALTH[id] = { checks:0, ok:0, pings:[], lastFail:0, lastOk:0 };
    }
    var h = PROXY_HEALTH[id];
    h.checks++;
    if (success) { h.ok++; h.lastOk = now(); }
    if (ping && ping < 500) {
        h.pings.push(ping);
...
var THROTTLE = {
    ...
    reset: function() { this.switchCount = 0; this.lockUntil = 0; }
};
...
var WARM = {
    ...
    update: function() {
        ...
        this.lastCheck   = now();
        this.bestStandby = bestProxy(["sync","game","fps","live"]);
    },

    get: function() { this.update(); return this.bestStandby; }
};
WARM.update();
...
function antiDetect(host) {
    ...
    var detectors = [
        ...
        "ipcheck","myleaktest","browserleaks"
    ];
...
function selectRoute(mode, score, ip, port, host) {
    ...
    if (criticalModes.indexOf(mode) !== -1) {
        ...
        if (CFG.DUAL_PROXY_CRITICAL &&
            (mode === "SYNC" || mode === "RANKED") && score > 45) {
...
function isTikTok(host) {
    ...
    for (var i = 0; i < GAME_DB.tiktokDomains.length; i++) {
        ...
        if (h === d || h.indexOf("." + d) !== -1 || h.indexOf(d) !== -1) return true;
    }
    return false;
}
...
function FindProxyForURL(url, host) {
    ...
    // ══ 3. THERMAL PROTECTION — يمنع السخونة ══
    //    يبلوك الإعلانات والتتبع والـ Analytics
    //    لكن لا يمس تيك توك أو PUBG أبداً
    if (THERMAL.isHeatSource(h))                     return BLOCK;

    // ══ 4. TIKTOK — DIRECT كامل بدون أي تدخل ══
...
function log(msg) {
    if (typeof console !== "undefined") console.log("[JO60] " + msg);
}
...
function getStatus() {
    return {
        ...
        thermal:     CFG.THERMAL_PROTECTION ? "🧊 COOL" : "🔥 HOT",
        tiktokLive:  CFG.TIKTOK_LIVE_PRIORITY ? "✅ Active" : "❌ Off",
        warmProxy:   WARM.get() ? WARM.get().id : "NONE",
        poolSize:    Object.keys(CONN_POOL.active).length,
        timeProfile: getTimeProfile(),
        geoBias:     CFG.GEO_BIAS_AGGRESSIVE ? "AGGRESSIVE 99% JO" : "NORMAL",
