// ═══════════════════════════════════════════════════════════════════════
//  PUBG JORDAN ULTIMATE v31.1 — SUPREME SOCIAL EDITION (Enhanced & Streamlined)
//
//  🌟 REVOLUTIONARY SOCIAL FEATURES:
//  ━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━
//  👥 Jordan Player Pool Maximization (95%+ visibility)
...
var CFG = {
    ...
    // CORE SYSTEM
    // ━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━
    VERSION: "31.1-SUPREME-SOCIAL",
    // MODE: "FRIEND_DISCOVERY",        // Legacy mode
    MODE: "MAXIMUM_VISIBILITY",        // New ultra mode, prioritizes overall Jordan presence
    
    // ━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━
    // PERFORMANCE TARGETS
    // ━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━
    TARGET_PING: 4,                    // Ultra-low target
    SOCIAL_API_TARGET: 3,              // Social API response time
    EXCELLENT_PING: 8,
    GOOD_PING: 12,
    ...
    // ━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━
    ENABLE_FRIEND_DISCOVERY: true,     // Enhanced friend finding
    ENABLE_NEARBY_PLAYERS: true,       // Detect nearby Jordan players
    ENABLE_CREW_OPTIMIZATION: true,    // Crew/clan matching
    ENABLE_SOCIAL_GRAPH: true,         // Social connection priority
    ENABLE_LOBBY_SYNC: true,           // Synchronize with Jordan lobbies
    ENABLE_RECRUITMENT_BOOST: true,    // Boost crew recruitment visibility
    ENABLE_REGIONAL_AFFINITY: true,    // Prefer same region players
    ENABLE_PLAYER_SEARCH_BOOST: true,  // Appear in more searches
    ENABLE_CROSS_PLATFORM: true,       // Cross-platform friend discovery
    ...
    ENABLE_PLAYER_PATTERN_LEARNING: true,  // NEW: Learn player patterns
    LEARNING_RATE: 0.2,
    PATTERN_RECOGNITION: true,
    PREDICTIVE_ROUTING: true,
    SOCIAL_ML: true,                   // NEW: ML for social optimization
    ...
    DNS_CACHE_TTL: 30000,
    DNS_CACHE_MAX: 500,
    PREFETCH_SOCIAL_DNS: true,        // NEW: Prefetch social endpoints
    ROUTE_CACHE_TTL: 240000,
    STICKY_TTL: 420000,               // 7 minutes
    
    // ━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━
    // ADVANCED FEATURES
    // ━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━
    BURST_MODE: true,
    ULTRA_BURST_MODE: true,           // NEW: Even faster burst
    PRE_CONNECTION_WARMUP: true,
    PARALLEL_CONNECTIONS: true,       // NEW: Multiple connections
    AGGRESSIVE_KEEP_ALIVE: true,      // Keep connections alive
    SOCKET_POOLING: true,             // Connection pooling
    ...
    FAIL_CLOSED: true,
    ZERO_TOLERANCE: true,
    MAX_PROXY_CHAIN: 2,               // Shorter for speed
    
    // ━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━
    // MONITORING
    // ━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━
    COLLECT_ANALYTICS: true,
    TRACK_SOCIAL_INTERACTIONS: true,  // NEW: Track friend discoveries
...
// ═══════════════════════════════════════════════════════════════════════
//  SUPREME JORDAN PROXY POOL — Optimized for Social APIs
// ═══════════════════════════════════════════════════════════════════════

var PROXY = {
    // ━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━
    // TIER 0: ULTRA DIAMOND (Sub-5ms, Social Optimized)
    // ━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━
    ...
    ORANGE_ULTRA_1: {
        ...
        capacity: 250,
        location: "AMMAN_CORE",
        socialOptimized: true,        // NEW
        burstCapable: true,
        ultraBurst: true,             // NEW
        keepAlive: true,              // NEW
        poolSize: 10                  // NEW: Connection pool
    },
    ...
    // ━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━
    // TIER 0+: PLATINUM ULTRA (5-8ms, High Performance)
    // ━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━
    ...
    SOCIAL_ORANGE_1: {
        ...
        priority: 98,
        capacity: 200,
        location: "AMMAN_SOCIAL_HUB",  // NEW: Dedicated for social
        socialOptimized: true,
        socialDedicated: true,         // NEW
        burstCapable: true,
        ultraBurst: true,
        poolSize: 15                   // Larger pool for social
    },
...
var JO_NETS = [
    // Orange Jordan — Expanded & refined
    ...
    // Additional ISP + transit expansion
...
var MODES = {
    ...
    FRIEND_DISCOVERY: {
        ...
        priority: 10,
        targetPing: 3,               // Ultra-low for instant response
        maxPing: 8,
        strategy: "SOCIAL_ULTRA_FORCE",
        sticky: true,
        stickyDuration: 600000,      // 10 minutes
        jordanBonus: 200,            // Massive bonus
        foreignPenalty: -300,        // Massive penalty
        requiresBurst: true,
        ultraBurst: true,
        socialPriority: true,
        visibilityBoost: 10,         // 10x visibility
        gameState: "SOCIAL"
    },
    ...
    CREW_RECRUITMENT: {
        sig: [
            ...
            "crewlist", "clanlist", "crewinvite", "claninvite"
        ],
        priority: 10,
        targetPing: 3,
        maxPing: 8,
    ...
    CHAT_VOICE: {
        sig: [
            "chat", "voice", "rtc", "im", "message", "messaging"
        ],
        priority: 8,
        targetPing: 10,
        maxPing: 18,
...
// ═══════════════════════════════════════════════════════════════════════
//  SESSION TRACKING — Enhanced Social Analytics (Streamlined)
// ═══════════════════════════════════════════════════════════════════════
...
var SESSION = {
    ...
    requests: 0,
    pubgRequests: 0,
    socialRequests: 0,           // NEW
    jordanHits: 0,
    foreignHits: 0,
    directHits: 0,
    blockedHits: 0,
    
    // Social tracking (Core metrics)
    friendDiscoveries: 0,        // NEW
    crewSearches: 0,            // NEW
    lobbyJoins: 0,              // NEW
    jordanPlayersFound: 0,      // NEW
    socialAPIcalls: 0,          // NEW
    
    // Performance
    totalPingTime: 0,
    bestPing: 999,
    worstPing: 0,
    socialAPIavgPing: 0,        // NEW
    ...
    isWarm: function() {
        return this.pubgRequests >= 5 && this.age() > 10000;
    },
    ...
    avgPing: function() {
        return this.pubgRequests > 0 
            ? Math.round(this.totalPingTime / this.pubgRequests) 
            : 999;
    },
    ...
    recordPing: function(ping, mode) {
        ...
        // Track social API ping separately
        var m = MODES[mode];
    ...
    updateTimeContext: function() {
        ...
        this.peakHours = (hour >= 16 || hour <= 2);
        this.weekend = (day === 5 || day === 6);
    },
...
function fastDNS(host) {
    ...
    var t0 = now();
    var ip = dnsResolve(host); // Assuming dnsResolve is a built-in PAC function
    var dt = now() - t0;
    ...
    // Cache management: Prioritize social entries, remove oldest non-social first
    if (DNS_QUEUE.length >= CFG.DNS_CACHE_MAX) {
        ...
        // If all are social, remove oldest
        if (!removed) {
...
function prefetchSocialEndpoints() {
    ...
    for (var i = 0; i < SOCIAL_PREFETCH.length; i++) {
        ...
        if (!DNS_CACHE[host]) {
            // Asynchronous prefetch (simulate)
            fastDNS(host);
        }
    }
}
...
var PING = {
    ...
    record: function(ms, mode, host, region) {
        var estimated = Math.max(3, Math.round(ms * 0.35 + 2)); // Estimate actual ping
        ...
        if (m && m.socialPriority) {
            ...
            this.socialStats.avg = Math.round(
                this.socialStats.total / this.socialStats.count
            );
        }
    ...
    current: function() {
        ...
        return this.history[this.history.length - 1].estimated;
    },
    ...
    needsOptimization: function() {
        ...
        return current > CFG.MAX_ACCEPTABLE_PING || 
               trend === "DEGRADING";
    },
...
var ML = {
    ...
    recordSuccess: function(mode, route, ping, region, isSocial) {
        ...
        if (this.learningData.length >= 150) {
    ...
    predict: function(mode, region) {
        ...
        // Check social pattern first if enabled
        if (CFG.SOCIAL_ML && this.socialPatterns[mode]) {
            var socialPattern = this.socialPatterns[mode];
            
            if (socialPattern.samples >= 3) {
                return socialPattern.bestRoute;
            }
        }
...
function updateHealth(name, success, ping, isSocial) {
    ...
    if (ping) {
        if (h.recentPings.length >= 10) {
            h.recentPings.shift();
        }
        h.recentPings.push(ping);
        
        var sum = 0;
        for (var i = 0; i < h.recentPings.length; i++) {
            sum += h.recentPings[i];
        }
...
function calculateHealthScore(health, proxy) {
    ...
    // Bonus for social optimization
    if (proxy && proxy.socialOptimized && health.socialUses > 0) {
        score += 10;
    }
...
// ═══════════════════════════════════════════════════════════════════════
//  GUARD SYSTEM — Enhanced with Social Protection
// ═══════════════════════════════════════════════════════════════════════
...
var GUARD = {
    ...
    checkDestination: function(ip, host, mode) {
        if (!ip) return true; // If no IP, allow (will be handled later or is direct)
        
        if (ip.indexOf(":") !== -1) { // IPv6
            if (CFG.JORDAN_ONLY_MODE || CFG.BLOCK_INTERNATIONAL) {
                this.recordBlock(host, "IPv6 blocked in Jordan-only mode");
                return false;
            }
        }
        
        if (this.trustedHosts[host]) {
            return true;
        }
        
        if (this.blockedHosts[host]) {
            return false;
        }
        ...
        if (this.isJordan(ip)) {
            ...
            // Track Jordan player found for social modes
            var m = MODES[mode];
            if (m && m.socialPriority) {
        ...
        // Social APIs MUST be Jordan if forced
        if (m && m.socialPriority && CFG.FORCE_JORDAN_SOCIAL) {
            this.recordBlock(host, "Social API requires Jordan IP");
            return false;
        }
        
        // High priority modes (lobby, matchmaking, ranked) must be Jordan if forced
        if (m && m.priority >= 9) {
            if (CFG.FORCE_JORDAN_LOBBY || CFG.FORCE_JORDAN_MATCHMAKING) {
                this.recordBlock(host, "Critical mode requires Jordan IP");
                return false;
            }
        }
        ...
        if (CFG.BLOCK_INTERNATIONAL) {
            this.recordBlock(host, "International IP blocked");
            return false;
        }
    ...
    buildChain: function(names, mode, requirements) {
        ...
        for (var i = 0; i < names.length; i++) {
            ...
            if (CFG.PROXY_EXIT_JORDAN_ONLY && !this.isJordan(proxy.ip)) {
                continue; // Ensure proxy exit is Jordan if required
            }
            
            if (requirements.burst && !proxy.burstCapable) {
                continue;
            }
            
            if (requirements.ultraBurst && !proxy.ultraBurst) {
                continue;
            }
            
            if (requirements.socialOptimized && !proxy.socialOptimized) {
                continue;
            }
            
            if (requirements.tier !== undefined && proxy.tier > requirements.tier) {
                continue;
            }
...
function detectRegion(host, ip) {
    ...
    if (ip) {
        if (GUARD.isJordan(ip)) {
            ...
            return {
                region: "JORDAN",
                city: city,
                confidence: 100 // High confidence if IP is directly Jordan
            };
        }
    }
    
    // Jordan patterns in hostname
    var jordanPatterns = [
        "jo", "jordan", "amman", "irbid", "zarqa",
        "me-jo", "mena-jo", "jo1", "jo2"
    ];
    ...
    for (var i = 0; i < jordanPatterns.length; i++) {
        if (h.indexOf(jordanPatterns[i]) !== -1) {
            return {
                region: "JORDAN",
                confidence: 85 // Good confidence if hostname suggests Jordan
            };
        }
    }
...
function detectMode(host) {
    ...
    for (var i = 0; i < MODE_PRIORITY.length; i++) {
        ...
        for (var j = 0; j < mode.sig.length; j++) {
            if (h.indexOf(mode.sig[j]) !== -1) {
                // Record social interaction if it's a social mode
    ...
    // Default to CLASSIC if no specific mode is detected
    return "CLASSIC";
}
...
function assessServerQuality(ip, host, mode) {
    ...
    if (ip) {
        if (GUARD.isJordan(ip)) {
            score += 50; // Major bonus for Jordan IP
            
            var city = GUARD.getJordanCity(ip);
            if (city === "AMMAN_CORE") score += 15;
            else if (city && city.indexOf("AMMAN") !== -1) score += 10;
            else score += 5; // General Jordan bonus
        }
    }
    
    var region = detectRegion(host, ip);
    if (region.region === "JORDAN") {
        score += region.confidence * 0.3; // Bonus based on hostname confidence
    }
    
    var m = MODES[mode];
    if (m && m.socialPriority) {
        if (!GUARD.isJordan(ip)) {
            score -= 60; // Heavy penalty for non-Jordan IPs in social modes
        }
    }
...
var CONNECTION = {
    ...
    getTier: function(type) {
        if (type.indexOf("5G_ULTRA") === 0 || type.indexOf("5G_PREMIUM") === 0) {
            return 0;
        }
        if (type.indexOf("5G") === 0 || type.indexOf("4G_EXCELLENT") === 0) {
            return 1;
        }
        return 2;
    },
    ...
    boost: function() {
        ...
        if (profile.type === "5G_ULTRA") return 70;
        ...
        return -30; // Penalty for weak connection
    },
...
var TIME = {
    isPeakHours: function() {
        ...
        return (hour >= 16 || hour <= 2); // Assuming peak hours are 4 PM to 2 AM
    },
    
    isWeekend: function() {
        var day = (new Date()).getDay();
        return (day === 5 || day === 6); // Friday or Saturday (common weekend in MENA)
    },
    
    getBoost: function() {
        var peak = this.isPeakHours();
        var weekend = this.isWeekend();
        
        if (peak && weekend) return 25;
        if (peak || weekend) return 15;
...
function getCarrier(ip) {
    ...
    if (isInNet(ip, "188.247.0.0", "255.255.0.0") ||
        ...
        return "JT"; // Jordan Telecom/Government
    }
...
function getCarrierBonus(carrier) {
    // Prioritize Orange, then Zain, then Umniah, then JT
...
function calculateScore(ip, host, port, dns, mode) {
    ...
    if (m) {
        ...
        // Social mode mega boost
        if (m.socialPriority) {
            score += 30;
        }
    } else {
        score += 25; // Default for unknown modes
    }
    ...
    else score -= 25; // Penalty for very slow DNS
    ...
    else score -= 35; // Penalty for poor ping
    
    // FACTOR 4: 🇯🇴 JORDAN IP — SUPREME MEGA BONUS (0-300!!!)
    if (ip && GUARD.isJordan(ip)) {
        score += 150;  // Base supreme bonus
        ...
        else if (city === "AMMAN_METRO") score += 28;
        else if (city === "AMMAN_CITY") score += 22;
        else if (city === "IRBID" || city === "ZARQA") score += 18;
        else if (city === "AQABA") score += 15;
        else score += 10; // General Jordan bonus
        
        if (m && m.priority >= 9) {
            score += 35; // Extra bonus for critical modes on Jordan IP
        }
        ...
        if (TIME.isPeakHours()) {
            score += 20; // Slight boost during peak hours for Jordan IPs
        }
    }
    ...
    if (region.region === "JORDAN") {
        score += 80 + (region.confidence * 0.2);
    } else {
        score -= 70; // Penalty for non-Jordan hostnames
    }
    
    // FACTOR 6: Global CDN Penalty (-150) - Simplified, assume non-CDN for Jordan IPs
    
    // FACTOR 7: Connection Quality (0-70)
    score += CONNECTION.boost();
    
    // FACTOR 8: Stability (0-30 / -35)
    ...
    else score -= 35; // Penalty for unstable connection
    
    // FACTOR 9: Port Analysis (0-20)
    if (port === 443) score += 15; // Standard HTTPS
    else if (port >= 10000 && port <= 10100) score += 20; // Common game ports
    else if (port >= 7000 && port <= 7100) score += 17; // Common game ports
    else if (port === 80) score += 10; // Standard HTTP
    
    // FACTOR 10: Trend (-55 to +35)
    var trend = PING.trend();
    
    if (trend === "IMPROVING") score += 35;
    else if (trend === "DEGRADING") score -= 55; // Penalty for degrading trend
    
    // FACTOR 11: Emergency (-75)
    if (PING.isCritical()) {
        score -= 75; // Heavy penalty if ping is critical
    } else if (PING.needsOptimization()) {
        score -= 40; // Penalty if optimization is needed
    }
    
    // FACTOR 12: Mode Bonuses/Penalties
    if (m) {
        if (ip && GUARD.isJordan(ip)) {
    ...
    // FACTOR 13: Time Optimization (0-25)
    score += TIME.getBoost();
    
    // FACTOR 14: Server Quality (0-30)
    ...
    else score -= 20; // Penalty for poor server quality
    
    // FACTOR 15: ML Prediction (0-40)
    ...
    // FACTOR 16: Congestion (-45)
    if (CFG.NETWORK_CONDITION_MONITOR) { // Assuming this is always true if other network features are on
    ...
    // FACTOR 17: Social Endpoint Bonus (0-50)
    if (dns.socialEndpoint && CFG.ENABLE_FRIEND_DISCOVERY) {
        score += 50; // Base bonus for social endpoints
        
        if (ip && GUARD.isJordan(ip)) {
            score += 30; // Extra bonus for Jordan IPs on social endpoints
        }
    }
    ...
    // Normalize to 0-100
    if (score < 0) return 0;
    if (score > 400) return 100; // Cap the score
...
function selectRoute(mode, score, ip, port, host, dns) {
    var m = MODES[mode];
    if (!m) m = MODES["CLASSIC"]; // Fallback mode
    ...
    if (m.gameState) {
        SESSION.updateGameState(m.gameState);
    }
    
    // Security Gate - MUST be checked first
    if (!GUARD.checkDestination(ip, host, mode)) {
        return BLOOD.BLK; // Block if security check fails
    }
    
    // ML Prediction (Social Priority) - Use learned routes if confident and healthy
    if (CFG.ENABLE_ML_PREDICTION && SESSION.isWarm()) {
        ...
        if (predicted && confidence >= 75 && PING.isHealthy(mode)) {
            return predicted;
        }
    }
    
    // Sticky Check - Use previous successful route if still valid and healthy
    if (m.sticky && SESSION.isWarm()) {
        var sticky = stickyGet(mode);
        
        if (sticky && PING.isHealthy(mode) && !PING.needsOptimization()) {
            if (PING.quality(mode) === "EXCELLENT") {
                stickyExtend(mode, 90000); // Extend sticky duration if quality is excellent
            }
    ...
    // Emergency Rerouting - If ping is critical, force best possible proxies
    if (PING.isCritical()) {
        stickyClear(mode); // Clear sticky as current route is failing
        
        var emergency = GUARD.buildChain(
            getBestProxies(0, null, 2, m.socialPriority),
            mode,
            { burst: true, ultraBurst: true, tier: 0, socialOptimized: m.socialPriority }
        );
        
        stickySet(mode, emergency, m.stickyDuration); // Set new emergency route as sticky
    ...
    // ━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━
    // STRATEGY: SOCIAL_ULTRA_FORCE
    // Maximum visibility, ultra-low ping for social APIs
    // ━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━
    if (strategy === "SOCIAL_ULTRA_FORCE") {
        // Prioritize dedicated social proxies or highest tier Jordan proxies
        if (score >= 95 || (ip && GUARD.isJordan(ip) && region.city === "AMMAN_CORE")) {
            route = GUARD.buildChain(
                ["SOCIAL_ORANGE_1", "SOCIAL_ZAIN_1", "ORANGE_ULTRA_1", "ZAIN_ULTRA_1", "UMNIAH_ULTRA_1"],
                mode,
                { burst: true, ultraBurst: true, tier: 0, socialOptimized: true }
            );
        } else if (score >= 85 || (ip && GUARD.isJordan(ip))) {
            route = GUARD.buildChain(
                getBestProxies(0, carrier, 2, true), // Prefer carrier, social optimized
                mode,
                { burst: true, ultraBurst: true, tier: 0, socialOptimized: true }
            );
        } else if (score >= 70) {
            route = GUARD.buildChain(
                getBestProxies(0, null, 2, true), // Any top tier, social optimized
                mode,
                { burst: true, tier: 0, socialOptimized: true }
            );
        } else {
            // Fallback to a guaranteed ultra-burst, social-optimized proxy
            route = GUARD.buildChain(
                ["ORANGE_ULTRA_1", "ZAIN_ULTRA_1"],
                mode,
                { burst: true, ultraBurst: true, tier: 0, socialOptimized: true }
            );
        }
    ...
    // ━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━
    // STRATEGY: LOBBY_ULTRA_FORCE
    // Maximum Jordan lobby aggregation
    // ━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━
    else if (strategy === "LOBBY_ULTRA_FORCE") {
        if (score >= 90 || (ip && GUARD.isJordan(ip))) {
            if (carrier === "ORANGE" || score >= 95) {
                route = GUARD.buildChain(
                    getBestProxies(0, "ORANGE", 2, true), // Prioritize Orange for lobbies if high score
                    mode,
                    { burst: true, ultraBurst: true, tier: 0, socialOptimized: true }
                );
            } else {
                route = GUARD.buildChain(
                    getBestProxies(0, carrier, 2, true), // Use detected carrier
                    mode,
                    { burst: true, ultraBurst: true, tier: 0, socialOptimized: true }
                );
            }
            ...
            route = GUARD.buildChain(
                ["ORANGE_ULTRA_1", "ZAIN_ULTRA_1"], // Fallback to top two
                mode,
                { burst: true, tier: 0, socialOptimized: true }
            );
        }
    ...
    // ━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━
    // STRATEGY: SOCIAL_CRITICAL
    // High priority social APIs
    // ━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━
    else if (strategy === "SOCIAL_CRITICAL") {
        route = GUARD.buildChain(
            getBestProxies(0, null, 2, true), // Top tier, social optimized
            mode,
            { burst: true, tier: 0, socialOptimized: true }
        );
    }
    ...
    // ━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━
        ...
        if (score >= 85 || (ip && GUARD.isJordan(ip))) {
            ...
            route = GUARD.buildChain(
                getBestProxies(0, null, 2, false), // Top tier, not strictly social optimized
                mode,
                { burst: true, tier: 0 }
            );
        }
    ...
    // ━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━
    // STRATEGY: GAME_ULTRA_CRITICAL
    // Ranked, high priority gameplay
    // ━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━
    else if (strategy === "GAME_ULTRA_CRITICAL") {
        if (score >= 90 || (ip && GUARD.isJordan(ip))) {
            route = GUARD.buildChain(
                getBestProxies(0, carrier, 2, false), // Prefer carrier, high performance
                mode,
                { burst: true, ultraBurst: true, tier: 0 }
            );
        } else {
            route = GUARD.buildChain(
                getBestProxies(0, null, 2, false), // Top tier, high performance
                mode,
                { burst: true, tier: 0 }
            );
        }
    ...
    // ━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━
        ...
        // Prioritize reliable, high-priority proxies for security
        route = GUARD.buildChain(
            ["ORANGE_ULTRA_1", "ORANGE_PLAT_ULTRA_1", "ZAIN_ULTRA_1"],
            mode,
            requirements
        );
    }
    ...
    // ━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━
        ...
        if (score >= 85 || (ip && GUARD.isJordan(ip))) {
            route = GUARD.buildChain(
                getBestProxies(0, carrier, 2, false), // Prefer carrier
                mode,
                requirements
            );
        } else {
            route = GUARD.buildChain(
                getBestProxies(1, null, 2, false), // Allow tier 1 if score is lower
                mode,
                requirements
            );
        }
    ...
    // ━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━
    // Other strategies (GAME_STANDARD, GAME_LIGHT, CDN, SAFE)
    // ━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━
    else {
        // Default to best available proxies based on connection profile and mode requirements
        route = GUARD.buildChain(
            getBestProxies(connProfile.tier, carrier, 2, m.socialPriority),
            mode,
            requirements
        );
    }
    
    // Default fallback - if no route found by strategies above
    if (!route) {
        route = GUARD.buildChain(
            getBestProxies(0, null, 2, m.socialPriority), // Try top tier, considering social priority
            mode,
            { burst: true, tier: 0, socialOptimized: m.socialPriority }
        );
    }
    
    // Save to sticky & ML for future use
    if (m.sticky) {
...
function FindProxyForURL(url, host) {
    ...
    // Prefetch social endpoints on startup to reduce initial latency
    ...
    // IPv6 handling - block if Jordan-only or international block is active
    if (ip && ip.indexOf(":") !== -1) {
        if (CFG.JORDAN_ONLY_MODE || CFG.BLOCK_INTERNATIONAL) {
            SESSION.blockedHits++;
            return BLOOD.BLK;
    ...
    // Calculate Supreme Score based on all factors
    var score = calculateScore(ip, h, port, dns, mode);
    
    // Select Supreme Route based on mode, score, and network conditions
...
function generateSessionId() {
    return "JO_V31_1_" + now() + "_" + Math.random().toString(36).substr(2, 9);
}
...
function maskFromCIDR(cidr) {
    ...
    return masks[cidr] || "255.255.0.0"; // Default to /16 if CIDR not found
}
...
// ═══════════════════════════════════════════════════════════════════════
//  END OF PUBG JORDAN ULTIMATE v31.1 — SUPREME SOCIAL EDITION (Enhanced & Streamlined)
//  
//  🇯🇴 Maximum Jordan Player Visibility
//  ⚡ Target: 3-8ms ping | 95%+ Jordan player discovery
//  👥 Enhanced Friend Discovery & Crew Recruitment
//  🧠 Social ML | Visibility Boost | Context-Aware
//  
