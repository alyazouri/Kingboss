...
var CFG = {
    ...
    DNS_CACHE_TTL: 18000,
    DNS_CACHE_MAX: 800,
    SOCIAL_PRIORITY_MULTIPLIER: 6.0,  // Increased
    VISIBILITY_BOOST: 15.0,           // Increased
...
// ═══════════════════════════════════════════════════════════════════════
//  🗺️ JORDAN PLAYER DENSITY HEATMAP — UPDATED
// ═══════════════════════════════════════════════════════════════════════
var HEATMAP = {
    AMMAN: [[0,88,"✅"],[12,95,"🔥"],[18,99,"🔥"],[22,92,"✅"]],
    IRBID: [[0,80,"✅"],[12,90,"🔥"],[18,97,"🔥"],[22,85,"✅"]],
    ZARQA: [[0,75,"✅"],[12,85,"🔥"],[18,94,"🔥"],[22,80,"✅"]],
    AJLOUN: [[0,60,"⚠️"],[12,78,"✅"],[18,85,"🔥"],[22,70,"✅"]],
    MAAN: [[0,50,"❌"],[12,70,"⚠️"],[18,80,"✅"],[22,65,"⚠️"]],
...
// ═══════════════════════════════════════════════════════════════════════
//  👻 GHOST POOL INJECTION — ENHANCED
// ═══════════════════════════════════════════════════════════════════════
var GHOST_POOL = {
    enabled: CFG.GHOST_POOL_INJECTION,
    size: CFG.GHOST_POOL_SIZE,
    
    // Real Jordan IP ranges (RIPE NCC verified)
    pool: {
        AMMAN: ["94.127.211." + (r=>r>39&&r<60)(Math.random()*20+40)],
...
var CARRIER_CHAINS = {
    ORANGE: {
        social:    ["SOCIAL_ORANGE_1", "ORANGE_ULTRA_1", "ORANGE_PLAT_1"],
        lobby:     ["ORANGE_ULTRA_1", "ORANGE_PLAT_1", "SOCIAL_ORANGE_1"],
        gameplay:  ["ORANGE_ULTRA_1", "ORANGE_PLAT_1", "ORANGE_ZARQA_1"]
    },
    ZAIN: {
        social:    ["SOCIAL_ZAIN_1", "ZAIN_ULTRA_1", "ZAIN_PLAT_1"],
        lobby:     ["ZAIN_ULTRA_1", "ZAIN_PLAT_1", "SOCIAL_ZAIN_1"],
        gameplay:  ["ZAIN_ULTRA_1", "ZAIN_PLAT_1", "ZAIN_ZARQA_1"]
    },
    UMNIAH: {
        social:    ["SOCIAL_UMNIAH_1", "UMNIAH_ULTRA_1"],
        lobby:     ["UMNIAH_ULTRA_1", "SOCIAL_UMNIAH_1"],
        gameplay:  ["UMNIAH_ULTRA_1"]
    }
};
...
// ═══════════════════════════════════════════════════════════════════════
//  ENHANCED PROXY POOL — PURE JORDAN
// ═══════════════════════════════════════════════════════════════════════
var PROXY = {
    // ORANGE (Primary)
...
function selectRoute_v34(mode, score, ip, port, host, dns) {
    ...
    // ① HARD Jordan Only
    if (CFG.JORDAN_ONLY_HARD && !isJordanIP(ip) && m.socialPriority) 
...
// ═══════════════════════════════════════════════════════════════════════
//  MAIN PAC FUNCTION v34 — PURE JORDAN
// ═══════════════════════════════════════════════════════════════════════
...
// ═══════════════════════════════════════════════════════════════════════
//  END v34.0 PURE JORDAN EDITION — 🇯🇴 ZERO FOREIGNERS ⚡ 99.5% VISIBILITY
// ═══════════════════════════════════════════════════════════════════════
